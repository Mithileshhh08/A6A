...
setwd("C:\\Desktop\\SCMA\\A6")
# Load the dataset
amz_data <- read.csv("AMZN Historical Data.csv")
...
ggplot(amz_data, aes(x = Date, y = Price)) +
  geom_line() +
  labs(title = "AMAZON Stock Price Over Time", x = "Date", y = "Price")
...
autoplot(decomp_additive) +
  ggtitle("Additive Decomposition of Amazon Stock Price") +
  theme_minimal()


# Plot the decomposed components for multiplicative model
autoplot(decomp_multiplicative) +
  ggtitle("Multiplicative Decomposition of Amazon Stock Price") +
  theme_minimal()
...
autoplot(daily_forecast) +
  ggtitle("Daily Forecast for Amazon Stock Price") +
  theme_minimal()
...
autoplot(monthly_forecast) +
  ggtitle("Monthly ARIMA Forecast for Amazon Stock Price") +
  theme_minimal()
